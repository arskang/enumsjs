    ...
    const genEnum = array => {
        try {
            ...
            array.forEach(element => {
                ...
                valEnum = new Enums(valEnum);
                valEnum.description = _description ? _description : _name;
                valEnum.value = valEnum;
                valEnum.name = _name;

                enums[_name.toUpperCase().replace(/ /g, '_')] = Object.freeze(valEnum);
                val = valEnum + 1;
            });
